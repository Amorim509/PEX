...
const CardImageRight: React.FC<CardImageRightProps> = ({ title, description, image }) => {
  ...
  return (
    ...
    >
      <CardBase className="w-[70%] ml-auto mr-0 my-4">
        <div id="investir" className="flex gap-4 items-center w-full">
